...
<div class="yellow accent-4">
    <!-- BACK ARROW ICON -->
      ...
      <v-btn style="text-decoration:none;" href="/guardian/home" icon light>
  ...
  <div class="text-xs-center mt-1">
      <!--Edit Info -->
        <v-btn v-on:click="clickGuardian(guardian)" color="transparent" depressed style="font-size: 10px" data-toggle="modal" data-target="#editinfo">Edit Info</v-btn>
      ...
      <!--Change Email -->
        <v-btn v-on:click="clickGuardian(guardian)" color="transparent" depressed style="font-size: 10px" data-toggle="modal" data-target="#changeemail">Change Email</v-btn>
...
export default {
  ...
  created() {
    ...
    return (this.fname = guardian.fname, this.lname = guardian.lname, this.email = guardian.email);
    },

    updateInfo() {
   axios
   .put("/guardian/updateinfo", {fname: this.fname, lname: this.lname, email: this.email})
   ...
   .catch(error => {
    ...
    updateEmail() {
   axios
   .put("/guardian/updateemail", {email: this.email})
   .then(response => {window.location.reload()})
   .catch(error => {
    ...
    updatePassword() {
   axios
   .put("/guardian/updatepassword", {password: this.password, password_confirmation: this.password_confirmation})
   .then(response => {window.location.reload()})
   .catch(error => {
